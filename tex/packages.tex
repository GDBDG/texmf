...
\usepackage[dvipsnames*, svgnames]{xcolor}% Donne des couleurs par défaut
...
\usepackage{listings} %https://borntocode.fr/latex-comment-inserer-et-customiser-du-code-source/
