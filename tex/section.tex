...
\newcommand{\setDescriptionSection}[1]{\renewcommand{\descriptionSection}{\textcolor{Silver}{#1}}}
\newcommand{\descriptionSection}{}
\newcommandx{\sectionC}[3][2=,3=1 usedefault]{\section{#1}}
\DeclareOption{dev}{
    \renewcommandx{\sectionC}[3][2=0, 3=1]{
        \IfEq{#3}{1}{
             \titleformat{\section}
